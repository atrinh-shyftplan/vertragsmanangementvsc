...
import { Bold, Italic, Underline, List, ListOrdered, Quote, CheckSquare, Indent, Outdent, AlignLeft, AlignCenter, AlignRight, AlignJustify, Variable } from 'lucide-react';
      ...
      <div className="flex flex-wrap items-center gap-1 p-3 border-b bg-muted/30">
        ...
        {globalVariables.length > 0 && (
          <Select onValueChange={(variable) => {
            ...
            <SelectContent className="bg-popover border shadow-md z-50 max-h-48 overflow-y-auto">
